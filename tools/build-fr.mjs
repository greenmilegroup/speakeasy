...
const PAGES = ['index.html', 'drinks.html', 'menu.html', 'events.html', 'private.html', 'visit.html', 'happy-hour.html', 'prix-fixe.html'];
...
function frenchCopy(html, page) {
  ...
  s = s.replace(/https:\/\/speakeasyottawa\.com\/((?:index|drinks|menu|events|private|visit|happy-hour|prix-fixe)\.html)?(?=[#"'\s])/g,
    (_, p) => `${SITE}/fr/${p || ''}`);
