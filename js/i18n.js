...
const FR = {
  ...
  "The Speakeasy Society: a membership card with your name on it. Free shows for you and a guest, priority seating, invite-only nights, 10% off your table.":
    "La Société Speakeasy : une carte de membre à votre nom. Spectacles gratuits pour vous et un invité, places prioritaires, soirées sur invitation, 10 % sur votre table.",
  "Your name on the card.": "Votre nom sur la carte.",
  "Your name": "Votre nom",
  "on the card.": "sur la carte.",
  "For the people who are already here. A card that gets you and a guest into the shows, a better table, and the nights we never announce.":
    "Pour ceux qui sont déjà ici. Une carte qui vous ouvre les spectacles, à vous et à un invité, une meilleure table, et les soirées que nous n'annonçons jamais.",
  "$50 a month. Founding members keep that for life.": "50 $ par mois. Les membres fondateurs gardent ce tarif à vie.",
  "The Speakeasy Society membership card": "La carte de membre de la Société Speakeasy",
  "Founding Member": "Membre fondateur",
  "Black, gold, your name and your number. In your wallet and on your phone.": "Noire, dorée, votre nom et votre numéro. Dans votre portefeuille et sur votre téléphone.",
  "What the card does": "Ce que fait la carte",
  "Five things,": "Cinq choses,",
  "every time.": "chaque fois.",
  "Free admission to ticketed shows, you and a guest": "Entrée gratuite aux spectacles à billets, vous et un invité",
  "General admission to every concert and comedy night on our stage, for you and one guest. Reserve by the day before; subject to availability.":
    "Admission générale à chaque concert et soirée d'humour sur notre scène, pour vous et un invité. Réservez la veille au plus tard; selon les disponibilités.",
  "Priority seating": "Places prioritaires",
  "Your reservation carries your name. We hold the better table.": "Votre réservation porte votre nom. Nous gardons la meilleure table.",
  "Invite-only nights": "Soirées sur invitation seulement",
  "Members' tastings, secret shows, the night before New Year's. Never announced. Members hear first, and only members come.":
    "Dégustations entre membres, spectacles secrets, la veille du Nouvel An. Jamais annoncées. Les membres l'apprennent d'abord, et seuls les membres viennent.",
  "First look at the big nights": "Premier accès aux grandes soirées",
  "New Year's Eve and Valentine's tickets before anyone else, at a member price.": "Les billets du Nouvel An et de la Saint-Valentin avant tout le monde, au tarif membre.",
  ...
  "a month.": "par mois.",
  "per month": "par mois",
  "Cancel any time. Plus HST.": "Annulable en tout temps. Plus TVH.",
  ...
  "Most weeks": "Presque chaque semaine",
  "A few times a month": "Quelques fois par mois",
  "About once a month": "Environ une fois par mois",
  "Not yet, and I have been meaning to": "Pas encore, mais j'y pense",
  "By requesting a card you agree to hear from us about your membership. Nothing is charged until you say yes to the link we send.":
    "En demandant une carte, vous acceptez que nous vous écrivions au sujet de votre adhésion. Rien n'est facturé tant que vous n'avez pas dit oui au lien que nous envoyons.",
  "The terms, in plain words": "Les conditions, en mots simples",
  "How it": "Comment ça",
  "works.": "fonctionne.",
  "Who it is for": "Pour qui",
  "Anyone 19 or older. Membership is personal and carries your name; it cannot be lent or transferred.": "Toute personne de 19 ans ou plus. L'adhésion est personnelle et porte votre nom; elle ne peut être prêtée ni transférée.",
  "Shows": "Les spectacles",
  "General admission to ticketed shows on our stage for you and one guest, reserved by the day before, subject to availability. Two no-shows in a season and the seats go back to the list for that season.":
    "Admission générale aux spectacles à billets sur notre scène pour vous et un invité, réservée la veille au plus tard, selon les disponibilités. Deux absences sans avis dans une saison et les places retournent à la liste pour cette saison.",
  "The big nights": "Les grandes soirées",
  "New Year's Eve, Valentine's Day and other special events are not included. Members get first access to those tickets, at a member price.":
    "Le Nouvel An, la Saint-Valentin et les autres événements spéciaux ne sont pas inclus. Les membres ont un premier accès à ces billets, au tarif membre.",
  ...
  "Paying": "Le paiement",
  "$50 a month, plus HST, charged automatically to the card you set up. You can cancel any time; your membership runs to the end of the period you have paid for.":
    "50 $ par mois, plus TVH, facturés automatiquement à la carte que vous enregistrez. Vous pouvez annuler en tout temps; votre adhésion court jusqu'à la fin de la période payée.",
  ...
  "Lost or stolen cards are replaced once free of charge. Your card is ours to withdraw if the membership is misused.": "Une carte perdue ou volée est remplacée une fois sans frais. Nous pouvons retirer la carte en cas d'usage abusif de l'adhésion.",
  "Changes": "Modifications",
  "We may change these terms or the benefits with thirty days' notice by email. If you do not like a change, you can cancel before it takes effect, whatever your start date.":
    "Nous pouvons modifier ces conditions ou les avantages avec un préavis de trente jours par courriel. Si un changement ne vous convient pas, vous pouvez annuler avant son entrée en vigueur, quelle que soit votre date de début.",
  "Terms as of September 2026.": "Conditions en vigueur en septembre 2026.",
  "A membership for the people who are already here. $50 a month.": "Une adhésion pour ceux qui sont déjà ici. 50 $ par mois.",
  "Free admission to shows, you and a guest": "Entrée gratuite aux spectacles, vous et un invité",
  "Every concert and comedy night on our stage.": "Chaque concert et soirée d'humour sur notre scène.",
  "Priority seating and 10% off your table": "Places prioritaires et 10 % sur votre table",
  "Your name on the reservation, the better table held.": "Votre nom sur la réservation, la meilleure table gardée.",
  "The nights that are never announced. Members hear first; only members come.": "Les soirées jamais annoncées. Les membres l'apprennent d'abord; seuls les membres viennent.",
  "Not ready for the card?": "Pas encore prêt pour la carte?",
  "The Guest List": "La liste d'invités",
  "Hear what is on before anyone else. Free.": "Sachez ce qui s'en vient avant tout le monde. Gratuit.",
  "Join the Guest List": "Joindre la liste d'invités",
  ...
  "Two windows a night, early and late. Dollar oysters, the cocktail of the week at half price, and $5 bar rail drinks.":
    "Deux moments par soir, tôt et tard. Huîtres à un dollar, cocktail de la semaine à moitié prix et alcools de base à 5 $.",
  "No ticket, no list, just a seat.": "Sans billet, sans liste, juste une place.",
  ...
  "A curated three course evening. Starter, main and dessert for one price, with live music on the nights the stage is lit.":
    "Une soirée trois services soigneusement composée. Entrée, plat et dessert pour un seul prix, avec musique live les soirs où la scène s'allume.",
  "$49 per guest.": "49 $ par personne.",
  "See the full menu →": "Voir le menu complet →",
  "How it works": "Comment ça marche",
  "Three courses,": "Trois services,",
  "one price.": "un seul prix.",
  "Book the Speakeasy Table on OpenTable, or tell your server when you sit down. Your server has the day's selection for each course. Prices in Canadian dollars, before tax and gratuity.":
    "Réservez la Table Speakeasy sur OpenTable, ou dites-le à votre serveur en vous installant. Votre serveur a la sélection du jour pour chaque service. Prix en dollars canadiens, avant taxes et pourboire.",
  "Starter": "Entrée",
  "Main": "Plat",
  "Dessert": "Dessert",
  "To begin. Your server has the day's selection.": "Pour commencer. Votre serveur a la sélection du jour.",
  "From the kitchen. Your server has the day's selection.": "De la cuisine. Votre serveur a la sélection du jour.",
  ...
  "We're a short walk from Rogers Centre Ottawa, the Rideau Centre and the Market's principal hotels, which is why we see so many": "Nous sommes à quelques pas du Centre Rogers Ottawa, du Centre Rideau et des principaux hôtels du Marché, ce qui explique le nombre de",
  ...
  "Sit Down.": "S'attabler.",
  "Now on OpenTable": "Maintenant sur OpenTable",
  "The Speakeasy": "La Table",
  "Table.": "Speakeasy.",
  ...
  "cocktail of the week": "cocktail de la semaine",
  "bar rail drinks": "alcools de base",
  "See the bar list": "Voir la carte du bar",
  "$1": "1 $",
  "$5": "5 $",
  "$49": "49 $",
  "$50": "50 $",
